...
describe("LendingPool", function () {
    ...
    it("does not allow liquidation of unexpired loans", async function () {
        ...
        await expect(this.lendingPool.connect(this.liquidator).doEffectiveAltruism(loanInfo, 0, this.liquidator.address)).to.be.revertedWith("not expired");
    });
    ...
    it("allows liquidation of expired loans", async function () {
        ...
        await this.lendingPool.connect(this.liquidator).doEffectiveAltruism(loanInfo, 0, this.liquidator.address);
